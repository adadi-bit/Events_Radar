"""
Run Events Radar locally.

    python main.py              # scrape everything, write docs/events.json, open the site
    python main.py --no-scrape  # just open the site with the current docs/events.json
...
if __name__ == "__main__":
    ...
    if not a.no_scrape:
        ...
        print(f"\n{s['total_active']} active events · {s['new']} new since last run\n")
    elif not (DOCS / "events.json").exists():
        scraper.export_json()
